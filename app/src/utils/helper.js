...
export class Helper {
  ...
  static showLogo() {
    ...
    centerLog(
      `${ConsoleColors.GREEN}WALRUS TESTNET BOT ${ConsoleColors.BLACK}| ${ConsoleColors.GREEN}@bangboong${ConsoleColors.RESET} ${ConsoleColors.BLACK}| ${ConsoleColors.GREEN}@you_and_crypus `
    );
